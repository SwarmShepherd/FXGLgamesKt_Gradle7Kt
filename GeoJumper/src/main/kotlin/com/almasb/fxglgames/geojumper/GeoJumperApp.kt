...
class PlatformControl : Component() {
    ...
    override fun onUpdate(tpf: Double) {
        //Sets up right/left shuttle between limits:  Reverses directions if to either right or left boundry
...
class GeoJumperApp : GameApplication() {
    ...
    override fun initSettings(settings: GameSettings) {
        with(settings) {
            credits = listOf(element = "Nancy Koller, Jonell Kretsch")
            width   = 600
            height  = 800
            title   = "Geo Jumper"
            version = "0.1"
    ...
    override fun initGame() {
        ...
        //Application specific - not GameApplication overrides
        initPlayer()
        initPlatforms()
    }
